    ...
    <div class="container">
      <div class="oss-cta__body">
        <h2 class="oss-cta__heading">
          We build<br>in the open.
        </h2>
        <p class="oss-cta__sub">
          Join the org, contribute, or just say hello.
        </p>
      </div>
